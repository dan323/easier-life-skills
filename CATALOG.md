...
> 8 skills · Last updated: 2026-04-25
...
| [`find-skills`](plugins/find-skills/skills/find-skills/SKILL.md) | Analyze the active repository and recommend relevant Claude Code skills from known marketplaces | ✓ | `/plugin install find-skills@easier-life-skills` |
