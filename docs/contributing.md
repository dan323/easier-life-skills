...
In Claude Code: `/plugin marketplace add ./` (from the repo root), then `/plugin install <your-skill-name>@easier-life-skills`.
...
2. `/plugin update <name>@easier-life-skills` in Claude Code
