...
| [`workflow`](plugins/workflow/skills/workflow/SKILL.md)                                           | Run multi-step skill workflows declared in workflow YAML â€” sequential execution with `${{ â€¦ }}` interpolation          |
